/**
 * @file SearchInput component - Search input with icon and clear button
 *
 * @description
 * Compact search input with search icon prefix and clear button.
 * Extends Input component styling with search-specific features.
 *
 * @example
 * ```tsx
...
const sizeMap = {
  ...
  md: { height: SIZE_HEIGHT_MD, fontSize: SIZE_FONT_SM, paddingX: SPACE_MD, iconSize: SIZE_ICON_MD },
