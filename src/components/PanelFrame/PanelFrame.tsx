/**
 * @file PanelFrame component - Floating panel container with header and close button
 *
 * @description
 * A fixed-width floating panel frame with a title header and optional close button.
 * Use as a container wrapper for content panels, property editors, and floating toolboxes.
 ...
 *
 * <PanelFrame title="Settings" onClose={() => setOpen(false)} width={280}>
...
/** Fixed-width floating panel frame with header, close button, and content area */
