/**
 * @file ConstraintsSectionDemo - Demo page for ConstraintsSection
 */
...
/**
 * ConstraintsSection demo page.
 */
export function ConstraintsSectionDemo() {
  ...
  return (
    <div style={containerStyle}>
      <div style={sectionWrapperStyle}>
        <ConstraintsSection data={data} onChange={setData} />
